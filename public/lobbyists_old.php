...
<head>
  ...
  <link rel="stylesheet" href="static/lobbyists_old.css?v=4">
</head>
<body>
      ...
      <div class="container-fluid dashboard-container-outer">
        <div class="row dashboard-container">
          ...
          <div class="col-md-12 chart-col version-select-container">
            <a href="./" class="link-button">Täglich aktualisierte Daten</a>
            <a href="./lobbyists_old.php" class="link-button active">Daten von 13/06/2023</a>
          </div>
          <!-- CHARTS - FIRST ROW -->
    ...
    <script src="static/lobbyists_old.js?v=4"></script>
